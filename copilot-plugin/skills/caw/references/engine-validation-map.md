...
| caw-write（論文・申請書執筆→`work/manuscripts/`、本人文体＋`work/papers/md/` 引用） | caw-es（ES 執筆→`work/documents/`、本人文体） | 生成 → 制約チェック | 本人文体の踏襲・制約（字数/引用整合）厳守・推敲ループ＋好み学習（writing-preferences）蓄積→次回先回り適用が機能する。**caw-es が研究側 caw-write / caw-input 両方の生成パスを検証** |
